...
import { ETH, ChainBsc, BNB } from '@/components/Icon';
...
const ShareLinks = ({ data }: { data: any }) => {
  ...
  return (
    <>
      {/* <IconButton
        ...
        onClick={() =>
          window.open(
            `${visitChain.blockExplorers?.default.url}/address/${data['project'].contract_address}`,
            '_blank',
          )
        }
      ...
      /> */}
      {!!data['project'].website_link && (
        <IconButton
          aria-label=""
          onClick={() => window.open(data['project'].website_link, '_blank')}
          colorScheme={'whiteAlpha'}
          color={isRare ? 'white' : 'primary.main'}
          icon={<WebsiteIcon fontSize={22} />}
        />
      )}
      {!!data['project'].facebook_link && (
        <IconButton
          aria-label=""
          onClick={() => window.open(data['project'].facebook_link, '_blank')}
          colorScheme={'whiteAlpha'}
          color={isRare ? 'white' : 'primary.main'}
          icon={<Icon as={FaFacebook} fontSize={20} />}
        />
      )}
      {!!data['project'].twitter_link && (
        <IconButton
          onClick={() => window.open(data['project'].twitter_link, '_blank')}
          colorScheme={'whiteAlpha'}
          aria-label=""
          color={isRare ? 'white' : 'primary.main'}
      ...
      {!!data['project'].telegram_link && (
        <IconButton
          onClick={() => window.open(data['project'].telegram_link, '_blank')}
          aria-label=""
          colorScheme={'whiteAlpha'}
          color={isRare ? 'white' : 'primary.main'}
      ...
      {!!data['project'].discord_link && (
        <IconButton
          onClick={() => window.open(data['project'].discord_link, '_blank')}
          colorScheme={'whiteAlpha'}
          aria-label=""
          color={isRare ? 'white' : 'primary.main'}
...
const SetRoyaltyButton = ({ collectionDetail }: { collectionDetail: any }) => {
  ...
  const contractAddress =
    collectionDetail['project'].contract_address || (query.id as string);
  ...
  return (
    <>
      <Box
        ...
        bgImage={{
          base: 'none',
          md: collectionDetail['project'].banner_image,
        }}
        bgPos="center"
      ...
      >
        {isLargerThan768 ? (
          ...
          <Box
            ...
            bgPos="center"
            bgSize="cover"
            bgImage={collectionDetail['project'].banner_image}
          />
        )}
          ...
          >
            ...
            >
              <AspectRatio
                ...
                overflow="hidden"
              >
                <Image src={collectionDetail['project'].logo} bg="#f2f2f2" />
              </AspectRatio>
            </Box>
            <VStack
              pos="relative"
            ...
            >
              <Box w="full">
                ...
                >
                  <HStack align={'center'}>
                    <Heading
                      ...
                      size="lg"
                      noOfLines={2}
                      color={isRare ? 'white' : '#14141F'}
                    >
                      {collectionDetail['project']?.name || 'Unamed'}
                    </Heading>
                ...
                {!!collectionDetail['project']?.description && (
                  <Box
                    color={isRare ? 'white' : 'primary.main'}
                  ...
                  >
                    <Ellipsis
                      rows={4}
                      content={collectionDetail['project']?.description}
              ...
              {isMounted && (
                ...
                >
                  ...
                  >
                    <StatLabel fontWeight={700} color="typo.sec">
                      {t('items')}
                    </StatLabel>
                    <StatNumber
                      color={isRare ? 'white' : 'primary.main'}
